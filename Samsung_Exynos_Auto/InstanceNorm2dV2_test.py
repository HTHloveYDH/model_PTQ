...
if __name__ == '__main__':
    torch_input = torch.randn(1, 2, 2, 2)
    # my version
    INV2 = InstanceNorm2dV2(2, affine=False, track_running_stats=True)
    ...
    # pytorch version
    IN = nn.InstanceNorm2d(2, affine=False, track_running_stats=True)
    ...
    print('updated running var of InstanceNorm2dV2: ', INV2.running_var, 'updated running mean of InstanceNorm2d: ', IN.running_var)
    print(abs(y - y_v2))